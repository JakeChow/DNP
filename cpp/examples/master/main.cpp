...
//AN ARRAY WITH EACH CROB CONTROL OPTION
    ...
    auto channel = manager.AddTCPClient("tcpclient", FILTERS, ChannelRetry::Default(), {IPEndpoint("192.168.20.58", 20000)},
...
//    auto integrityScan2 = master->AddClassScan(ClassField::(ClassField::CLASS2), TimeDuration::Minutes(1));
